...
const FloatingToolbar = () => {
  ...
  return (
    <Draggable handle=".drag-handle" nodeRef={nodeRef}>
      ...
      >
        {/* Drag Button */}
        <IconButton className="drag-handle" size="small">
        ...
        <Collapse in={open}>
          ...
          >
            ...
            <IconButton
              ...
              sx={{
                color: selectedTool === "create" ? "red" : "default",
                bgcolor:
                  selectedTool === "create"
                    ? "rgba(212,214,211, 0.3)"
                    : "transparent",
              }}
            >
              {selectedTool === "create" ? (
            ...
            <IconButton
              ...
              sx={{
                color: selectedTool === "delete" ? "red" : "default",
                bgcolor:
                  selectedTool === "delete"
                    ? "rgba(212,214,211, 0.3)"
                    : "transparent",
            ...
            <IconButton
              ...
              sx={{
                color: selectedTool === "move" ? "red" : "default",
                bgcolor:
                  selectedTool === "move"
                    ? "rgba(212,214,211, 0.3)"
                    : "transparent",
            ...
            <IconButton
              ...
              sx={{
                color: selectedTool === "rotate" ? "red" : "default",
                bgcolor:
                  selectedTool === "rotate"
                    ? "rgba(212,214,211, 0.3)"
                    : "transparent",
